<template>
  <div>
    ...
    <v-spacer></v-spacer> 
    <v-btn depressed dark @click="back" color="#1c1c1c">Go Back</v-btn>
    
    <v-toolbar-items class="hidden-sm-and-down">
     
      <v-btn flat dark>Hii {{user}}</v-btn>
      <v-btn dark color="#1c1c1c" depressed @click="logout">Logout</v-btn>
    </v-toolbar-items>
  </v-toolbar>
  </div>
</template>
...
.dot{ color: #ffffff;}
.logo-header {color:white;font-size: 40px;font-family: 'Shadows Into Light', cursive; cursor: pointer;}
